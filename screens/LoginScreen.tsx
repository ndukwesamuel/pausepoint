...
const LoginScreen = ({ }: {}) => {
    ...
    const {
        ...
        user_isLoading,
        user_message,
    } = useSelector((state: any) => state.AuthSlice)
    ...
    return (
        ...
        <AppScreen>
            ...
            <KeyboardAvoidingView
                ...
                style={{ flex: 1 }}>
                <View style={{ paddingHorizontal: 20, paddingTop: 20, height: "100%", justifyContent: "center" }}>

                    <RegistraionHeadersText data="Welcome back" textStyle={{}} />

                    <View style={{ flexDirection: "row", gap: 10, marginBottom: 30 }}>
                        <RegistraionParagraphText data="Don’t have an account? " color="#8E8E8F" />


                        <TouchableOpacity onPress={() => dispatch(authScreenChange("REGISTER"))}>
                    ...
                    <View style={{ flexDirection: "row", justifyContent: "space-between", alignItems: "center" }}>
                        ...
                        >
                            <Ionicons
                                name={`${remember ? "checkmark-circle-sharp" : "checkmark-circle-outline"}`}
                                size={24} color={`${remember ? "green" : "gray"}`} />
                        ...
                        >
                            ...
                            <TouchableOpacity onPress={() => dispatch(authScreenChange("FORGOTTENPASSWOD"))}>
