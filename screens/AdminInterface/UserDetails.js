    ...
    <View style={{ flex: 1, paddingHorizontal: 20, paddingTop: 20 }}>
      ...
      >
        ...
        <View style={{ flex: 1, gap: 5 }}>
          <SemiBoldFontText data="Jane Doe" textstyle={{ fontSize: 22 }} />
          <MediumFontText
      ...
      >
        ...
        <View style={{ marginBottom: 5, paddingBottom: 10 }}>
          <RegularFontText
            ...
            textstyle={{ fontSize: 13, color: "#696969" }}
          />
          <MediumFontText data="081234567890" textstyle={{ fontSize: 19 }} />
        </View>
      </View>
      ...
      >
        ...
        >
          <RegularFontText
            ...
            textstyle={{ fontSize: 14, color: "#696969", width: "30%" }}
          />
          <MediumFontText data="Pending" textstyle={{ fontSize: 14 }} />
        </View>
        ...
        >
          <RegularFontText
            ...
            textstyle={{ fontSize: 14, color: "#696969", width: "30%" }}
          />
          <MediumFontText data="Active" textstyle={{ fontSize: 14 }} />
        </View>
      ...
      <Formbutton
        buttonStyle={{
          backgroundColor: item?.status === "approved" ? "#FDF2F3" : "#04973C",
