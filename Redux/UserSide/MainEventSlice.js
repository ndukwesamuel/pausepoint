...
const initialState = {
  userevent_data: null,
  userevent_isError: false,
  userevent_isSuccess: false,
  userevent_isLoading: false,
  userevent_message: null,

  generalevent_data: null,
  generalevent_isError: false,
  generalevent_isSuccess: false,
  generalevent_isLoading: false,
  generalevent_message: null,

  singleEvent_Data: null,
  singleEvent_isError: false,
  singleEvent_isSuccess: false,
  singleEvent_isLoading: false,
  singleEvent_message: null,
};
...
export const { reset_MainEventSlice } = MainEventSlice.actions;
